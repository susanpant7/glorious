            ...
            <div className="mt-10 space-y-8 text-slate-700">
              <div>
                ...
                <p className="mt-4 text-sm leading-relaxed">
                  These Terms and Conditions ("Terms") govern your use of glowrious.shnmart.com (the "Site") and any purchase of products from GlowRious / Yuva Trade Concern ("we," "us," "our"). By accessing the Site or placing an order, you agree to these Terms.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed">
                  GlowRious is a skincare and haircare brand owned and operated by Yuva Trade Concern, based at {site.contact.address}. Products are currently sold via shnmart.com and our online store.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="mt-3 space-y-3 text-sm leading-relaxed">
                  ...
                  <li className="flex gap-3">
                    <span className="text-slate-600">•</span>
                    <span>Prices are listed in NPR and are subject to change without notice. Prices at the time of order confirmation will apply.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-slate-600">•</span>
                    <span>Payment is processed through ShnMart checkout. By placing an order, you confirm that the payment information provided is accurate and that you are authorized to use the chosen payment method.</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed">
                  Estimated delivery timelines and shipping charges are set out on our Shipping Policy and FAQ pages. Delivery dates are estimates only; we are not liable for delays caused by couriers, customs, weather, or other circumstances beyond our reasonable control.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed">
                  Returns, exchanges, and refunds are governed by our separate{" "}
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed">
                  All content on the Site, including text, graphics, logos, product names, images, and the Neosome™ name and branding, is the property of GlowRious/Yuva Trade Concern or its licensors, and is protected by applicable intellectual property laws. You may not copy, reproduce, distribute, or create derivative works from this content without our prior written consent.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed">
                  To the maximum extent permitted by applicable law, GlowRious / Yuva Trade Concern shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Site or our products, including but not limited to allergic reactions resulting from undisclosed sensitivities or misuse of products contrary to label instructions.
                </p>
                <p className="mt-3 text-xs text-slate-500 italic">
                  Note: This limitation should be reviewed by a lawyer, as liability limitations for cosmetic products often have specific requirements under local consumer protection law.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed">
                  You agree to indemnify and hold harmless GlowRious / Yuva Trade Concern, its officers, employees, and partners from any claims, damages, or expenses arising from your violation of these Terms or misuse of the Site or products.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed">
                  These Terms are governed by the laws of Nepal, without regard to conflict-of-law principles. Any disputes shall be subject to the exclusive jurisdiction of the courts of Kathmandu.
                </p>
              </div>
              ...
              <div className="border-t border-slate-200 pt-6">
                <p className="text-xs text-slate-500 italic">
                  This policy is current as of June 18, 2026. GlowRious reserves the right to update these Terms at any time. Please check this page regularly for updates.
                </p>
              </div>
            </div>
          </div>
