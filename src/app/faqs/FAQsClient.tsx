...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "The GlowRious Skin Lightening Serum is a next-generation depigmentation and brightening serum powered by NEOSOME(TM) Technology. It contains eleven clinically respected active ingredients working across four functions: brightening, exfoliation, skin repair, and antioxidant protection to target dark spots, hyperpigmentation, melasma, uneven skin tone, and dullness.",
  },
  {
    id: "products-6",
    category: "Products",
    question: "What is NEOSOME(TM) Technology?",
    answer: "NEOSOME(TM) is an advanced encapsulation system that wraps each active ingredient inside microscopic liposomal and niosomal carriers. These carriers protect fragile actives like Vitamin C from breaking down, carry them deeper into the skin layers where pigment is actually formed, and release them gradually for a longer-lasting effect. Most ordinary serums leave actives on the surface where they quickly evaporate or degrade. NEOSOME(TM) ensures they reach where they work.",
  },
  {
    id: "products-7",
    category: "Products",
  ...
  },
  {
    ...
    answer: "Yes, the formula uses gentle mandelic acid rather than more aggressive exfoliants, and includes soothing actives like liquorice extract and D-Panthenol. The NEOSOME(TM) system's controlled-release mechanism further reduces the risk of irritation. We recommend doing a patch test on the inner arm before full facial use and starting with an application every other night.",
  },
  {
    id: "products-10",
    category: "Products",
  ...
  },
  {
    ...
    answer: "2-3 drops are sufficient for the full face. Do not over-apply. The NEOSOME(TM) encapsulation system means a small amount goes a long way.",
  },
  {
    id: "products-14",
    category: "Products",
  ...
  },
  {
    ...
    answer: "Creating an account is optional. However, it allows you to track orders, save favorites, and access personalized recommendations. You can also check out as a guest.",
  },
  {
    id: "account-2",
    category: "Account",
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 py-12">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-2 text-lg text-slate-600">
            Have a question about GlowRious? Find answers below on our skincare products, NEOSOME Technology, ordering, delivery, returns, and account help, organized by category so you can jump straight to what you need.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="space-y-4">
            {filteredFAQs.map((item) => (
              <div
                key={item.id}
                className="overflow-hidden rounded-lg border border-slate-200 bg-white transition hover:border-amber-300"
              >
                <button
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm font-medium text-amber-600">{item.category}</p>
                  </div>
                  <ChevronDown
                    className={`h-5 w-5 flex-shrink-0 text-amber-400 transition-transform ${
