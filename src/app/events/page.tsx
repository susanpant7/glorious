  ...
  return (
    <section>
      <div className="mb-8 flex flex-col gap-3">
        <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#eea504]">{eyebrow}</p>
    ...
    <div className="bg-gradient-to-b from-slate-50 via-slate-100 to-slate-50 py-16">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-12 flex flex-col gap-4 text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.32em] text-[#eea504]">Events</p>
          <h1 className="text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">
            Upcoming events & experiences
          </h1>
          <div className="mx-auto h-1.5 w-28 rounded-full bg-[#eea504]" />
